    ...
    helpPages.push_back({
        "基础命令",
        {
            ...
            {"\033[1;36mvars\033[22m", 
             ...
             "\n\033[1m增强型变量预览器功能:\033[0m\n"
             "- 支持在变量列表上方输入筛选内容，动态过滤变量名\n"
             "- 支持输入 \033[1;33m<!MATRIX>\033[0m、\033[1;33m<!VECTOR>\033[0m、\033[1;33m<!FRACTION>\033[0m、\033[1;33m<!RESULT>\033[0m、\033[1;33m<!EQUATION_SOLUTION>\033[0m 进行类型过滤\n"
             "- 例如输入 \033[1;33m<!MATRIX>\033[0m 只显示所有矩阵变量，输入 \033[1;33mrs\033[0m 只显示名称包含 rs 的变量\n"
             "- 支持上下键选择，ESC退出\n"
             "\n\033[2m示例:\033[0m\n"
    ...
    helpPages.push_back({
        "代数运算",
        {
            ...
            {"\033[1;36malg_solve\033[22m", 
             "求解代数方程。\n\n"
             "\033[1m用法:\033[0m\n"
             "- alg_solve(<表达式>): 求解 <表达式> = 0\n"
             "- alg_solve(<表达式1> = <表达式2>): 求解方程\n"
             "\n\033[1m说明:\033[0m\n"
             "- 支持求解一次和二次方程。对于二次方程，当解为无理数时，会以根式形式表示。\n"
             "- 根式中sqrt()表示平方根，cbrt()表示立方根，root(base,exp)表示base开exp次方根\n"
             "- 对于高次方程，会尝试通过有理根定理进行因数分解\n"
             "- 对于无法求得有理解的高次方程的根，系统将返回CANT_SOLVE\n"
             "\n\033[2m示例:\033[0m\n"
             "\033[1;33m> alg_solve(2*x^6 - 21*x^5 + 43*x^4 + 48*x^3 - 126*x^2 - 27*x + 81)\033[0m\n"
             "\033[36m[结果: x₁ = -1, x₂ = 1, x₃ = 3, x₄ = 3/2, x₅ = 3 + 3*sqrt(2), x₆ = 3 - 3*sqrt(2)]\033[0m\n"
             "\033[1;33m> alg_solve(x^2 = 2)\033[0m\n"
             "\033[36m[结果: x₁ = sqrt(2), x₂ = -sqrt(2)]\033[0m"
            }
        }
    });
